...
// с помощью map перебираем все элементы(символы) в textToStars(map делает из строки массив символов). 
// условие: vowels содержат в себе проверяемый символ из textToStars? если да, меняем этот символ на *, 
// если нет, то возвращаем этот символ в качестве элемента String(фактически, как элемент массива)
